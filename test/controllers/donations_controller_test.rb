...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { pickup_end: @donation.pickup_end, pickup_start: @donation.pickup_start, status: @donation.status }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { pickup_end: @donation.pickup_end, pickup_start: @donation.pickup_start, status: @donation.status }
    assert_redirected_to donation_path(assigns(:donation))
  end
